...
<head>
    ...
    <!-- HTML Meta Tags -->
    <meta name="description" content="view the pine online retail website project by paul aries, a responsive website that implements CSS media queries, flexbox, grid, and a JavaScript plugin.">
...
<main class="flex col aic jcc">
    <section class="grid col-12-8-4 project-section">
        <div class="paragraph s-1 s-1-sm s-1-md callout project-reveal">
            <h4>the goal</h4>
            <div>
                <p>design a website of our choice, implementing CSS media queries, flexbox, grid, and a JavaScript plugin. the final product should result in a fully responsive website that is modern and visually appealling.</p>
            </div>
        </div>
        <div class="no-margin paragraph s-1 s-1-sm s-1-md project-reveal">
            <h5>getting started</h5>
            <p>inspired by the types of websites i frequently visit, i decided to design an online retail store for a small, fictional fashion line called <strong>Pine</strong>.</p>
            <br>
            <p>i drafted three wireframes in Figma per page: <strong>one desktop</strong>, <strong>one tablet</strong>, and <strong>one mobile</strong>. having different viewports allowed for different layouts per device, which enabled the final website to have an exciting yet intuitive interface no matter the window’s size. i understood that creating three responsive pages for three different pages was going to be a challenge, but i always enjoy the problem-solving process!</p>
        </div>    
        <div class="media s-1 s-1-sm s-1-md project-reveal">
            <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fdesign%2Fh8iqY8j5rhOQ2PaSeGe1Yv%2Fpine%3Fnode-id%3D0-1%26t%3Dl5EPptFN6uNRGA9Z-1" allowfullscreen></iframe>
        </div>
        <div class="paragraph s-1 s-1-sm s-1-md project-reveal">
            <h5>HTML, CSS, and JS development</h5>
            <p>based on the wireframes, i created the structure of each page using HTML and CSS. utilizing media queries, i was able to adjust flexbox and grid properties for each viewport, as well as adjust the sizing of elements accordingly.</p>
            <br>
            <p>adhering to the wireframes was a challenge, as they did not represent the in-betweens of the three viewports. i found myself often shuffling through different values to make sure each page looked how i wanted, in all window sizes. this proved to be an obstacle for sure, but through lots of trial and error, i got the website to be as accurate as i hoped for!</p>
        </div>
        <div class="no-margin paragraph s-1 s-1-sm s-1-md flex col gap-16 project-reveal">
            ...
            <p>with <strong>Isotope</strong> and <strong>Splide</strong> plugins, i was also able to add functionality to Pine’s pages, allowing users to filter through the different products and navigate through an image gallery. learning these plugins was initially a challenge, as i was unfamiliar with these plugins and their syntax. however, i was able to get the results i desired thanks to the plugin’s extensive documentation.</p>
        ...
        <div class="paragraph s-1 s-1-sm s-1-md project-reveal">
            ...
            <p>Pine’s brand identity is an original idea, with inspiration taken from the beautiful environment and colors of Vancouver; the brand’s logo was created using Illustrator.</p>
            <br>
