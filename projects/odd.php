...
<main class="flex col aic jcc">
    <section class="grid col-12-8-4 project-section">
        ...
        <div class="no-margin paragraph s-1 s-1-sm s-1-md project-reveal">
            ...
            <p>i began by defining the app functionalities, ensuring a clear understanding of the necessary features and user needs; this involved analyzing the competition, focusing on apps with a similar <strong>user flow</strong> (searching, selecting, and purchasing a product).</p>
        </div>
        <div class="paragraph s-2 s-2-sm s-2-md project-reveal">
            <q>by studying other mobile retail apps, i was able to align with the user interaction law of consistency, ensuring that the app’s interface and process felt familiar to users.</q>
        </div>
