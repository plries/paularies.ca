...
<head>
    ...
    <!-- HTML Meta Tags -->
    <meta name="description" content="hey there, i'm paul aries! i'm a passionate, user-centered front-end developer and ux/ui designer. explore my portfolio, view my work, and connect with me!">
    <meta name="author" content="Paul Aries">
    <meta name="keywords" content="Paul Aries, front-end developer, UX/UI designer, portfolio, web development, user experience, user interface design">
    <!-- Facebook Meta Tags -->
    ...
    <meta property="og:description" content="hey there, i'm paul aries! i'm a passionate, user-centered front-end developer and ux/ui designer. explore my portfolio, view my work, and connect with me!">
    ...
    <meta name="twitter:description" content="hey there, i'm paul aries! i'm a passionate, user-centered front-end developer and ux/ui designer. explore my portfolio, view my work, and connect with me!">
        ...
        <div class="intro cell s-1 s-1-sm s-1-md flex flex-toggle aic gap-24">
            ...
            <div class="flex col gap-16 jcsb">
                <div class="flex col gap-16">
                    <h5>my passion for both art and technology has always driven me to merge the two creatively.</h5>
                    <p>this desire has led me to front-end development and ux/ui design—now im able to adapt my skills, build solutions, and help users navigate the digital world seamlessly.</p>
                </div>
                <div class="flex jcr">
